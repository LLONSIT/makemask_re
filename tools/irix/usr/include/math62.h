...
#if _NO_XOPEN4 && _NO_XOPEN5 && _XOPEN5 && (defined(__INLINE_INTRINSICS) && \
...
#if (defined(__INLINE_INTRINSICS) && \
	(_MIPS_SIM==_MIPS_SIM_NABI32 || _MIPS_SIM==_MIPS_SIM_ABI64))
