 ...
 *
 ...
 |
 |   Description:
 |      Defines the SoV1PointLightKit class. 
 |      Subclassed off of SoV1LightKit, this class adds an SoPointLight
 |      node to the catalog.
 |
...
SoEXTENDER class SoV1PointLightKit : public SoV1LightKit {
