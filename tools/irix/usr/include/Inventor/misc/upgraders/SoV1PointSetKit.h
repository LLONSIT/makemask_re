 ...
 *
 ...
 |
 |   Description:
 |      Defines the SoV1PointSetKit class. 
 |      Subclassed off of SoV1VertexShapeKit, this class adds an SoPointSet node.
 |
...
SoEXTENDER class SoV1PointSetKit : public SoV1VertexShapeKit {
