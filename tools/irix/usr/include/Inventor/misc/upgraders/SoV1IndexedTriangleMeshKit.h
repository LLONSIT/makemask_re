 ...
 *
 ...
 |
 |   Description:
 |      Defines the SoV1IndexedTriangleMeshKit class. 
 |      Subclassed off of SoV1VertexShapeKit, 
 |		this class adds an SoIndexedTriangleMesh node.
 |
...
SoEXTENDER class SoV1IndexedTriangleMeshKit : public SoV1VertexShapeKit {
