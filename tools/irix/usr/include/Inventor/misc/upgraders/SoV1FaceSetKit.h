 ...
 *
 ...
 |
 |   Description:
 |      Defines the SoV1FaceSetKit class. 
 |      Subclassed off of SoV1VertexShapeKit, this class adds an SoFaceSet node.
 |
...
SoEXTENDER class SoV1FaceSetKit : public SoV1VertexShapeKit {
