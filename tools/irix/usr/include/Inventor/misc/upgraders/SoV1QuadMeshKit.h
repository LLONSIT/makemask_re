 ...
 *
 ...
 |
 |   Description:
 |      Defines the SoV1QuadMeshKit class. 
 |      Subclassed off of SoV1VertexShapeKit, this class adds an SoQuadMesh node.
 |
...
SoEXTENDER class SoV1QuadMeshKit : public SoV1VertexShapeKit {
