...
#define FDC_ERR_DIRXFS  5067    /* O_DIRECT flag used with ffopen/ffopens only supported */
                                /* on XFS-filesystem resident files                      */
#define FDC_ERR_BADALGN 5068    /* Data buffer not aligned on ffsw.d_mem byte boundary */
#define FDC_ERR_BADRECL 5069    /* Incorrect data buffer record length */
