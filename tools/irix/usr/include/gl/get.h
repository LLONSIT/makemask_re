...
#define HZ75			31	/* 75HZ monitor timing*/ 
#define SQR_RECT                32      /* StereoGraphics Stereo, 616x492x2 */
#define SQR_BOT                 33      /* Stereo, bottom buffer primary */
#define SQR_TOP                 34      /* Stereo, top buffer primary */
