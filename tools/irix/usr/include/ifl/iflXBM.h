...
/*
    ...
    XBM image file format.

    The following quasi-prototypes illustrate the use of these tag values:

	getTag(iflXBMhotSpot, int* x, int* y)
	
	    returns location of hot spot in 'x' and 'y'
	    
	setTag(iflXBMhotSpot, int x, int y)
	
	    sets location of hot spot to 'x' and 'y'
	    
*/

enum { 
    iflXBMhotSpot = 0	/* hot spot */
};
