...
#define _iflTIFF_h_
/*
    This tag values used with the getTag() method are the TIFF field
    values defined by <tiff.h>.
    
    The setTag() method is used to set any of the above TIFF fields with 
    the exception of:
