#ifndef __SIGNAL_CORE_H__
#define __SIGNAL_CORE_H__
#ident "$Revision: 1.5 $"
/*
 *
...
/*REFERENCED*/
static int sigaltstack(const stack_t *_nss, stack_t *_oss)
{
	return __xpg4_sigaltstack(_nss, _oss);
}
