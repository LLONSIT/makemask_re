...
#ifndef __LIMITS_CORE_H__
#define __LIMITS_CORE_H__
...
#ifndef _KERNEL
extern long _sysconf(int);	/* Want this prototype, but cannot include
				 * <unistd.h> here because of name-space
				 * pollution.
				 */
#endif /* _KERNEL */
#endif /* Language C or C++ */

#ifndef _SC_THREAD_DESTRUCTOR_ITERATIONS
/* Must hard-code constants here because including <unistd.h> causes
 * name-space pollution and exposes conflicting function prototypes.
 */
#define PTHREAD_DESTRUCTOR_ITERATIONS _sysconf(103) /* _SC_THREAD_DESTRUCTOR_ITERATIONS */
#define PTHREAD_KEYS_MAX _sysconf(104)              /* _SC_THREAD_KEYS_MAX */
#define PTHREAD_STACK_MIN _sysconf(105)             /* _SC_THREAD_STACK_MIN */
#define PTHREAD_THREADS_MAX _sysconf(106)           /* _SC_THREAD_THREADS_MAX */
#else
#define PTHREAD_DESTRUCTOR_ITERATIONS _sysconf(_SC_THREAD_DESTRUCTOR_ITERATIONS)
#define PTHREAD_KEYS_MAX _sysconf(_SC_THREAD_KEYS_MAX)
#define PTHREAD_STACK_MIN _sysconf(_SC_THREAD_STACK_MIN)
#define PTHREAD_THREADS_MAX _sysconf(_SC_THREAD_THREADS_MAX)
...
#define	NL_LANGMAX	28		/* max # of bytes in a LANG name */
