...
#ifndef __SETJMP_CORE_H__
#define __SETJMP_CORE_H__
#ident "$Revision: 1.4 $"
...
extern int 	_setjmp(__SGI_LIBC_NAMESPACE_QUALIFIER jmp_buf);
extern void 	_longjmp(__SGI_LIBC_NAMESPACE_QUALIFIER jmp_buf, int);
#if (defined(_COMPILER_VERSION) && (_COMPILER_VERSION >= 730))
