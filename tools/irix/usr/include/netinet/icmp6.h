...
struct icmp6_iphdr {
	struct icmp6_hdr icmp6_icmp;
	struct ipv6  	icmp6_ip;
};
...
#define ICMP6_ND_HOPS			255
#define ICMP6_MLD_HOPS			1
...
#define ICMP6_FILTER_SETPASSALL(filtp) {\
	(filtp)->icmp6_filt[1] = (filtp)->icmp6_filt[0] = 0xffffffff; \
	(filtp)->icmp6_filt[3] = (filtp)->icmp6_filt[2] = 0xffffffff; \
	(filtp)->icmp6_filt[5] = (filtp)->icmp6_filt[4] = 0xffffffff; \
	(filtp)->icmp6_filt[7] = (filtp)->icmp6_filt[6] = 0xffffffff; \
	}
