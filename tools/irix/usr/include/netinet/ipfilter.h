 ...
 *
 * Copyright 1990-2002, Silicon Graphics, Inc. 
 * All Rights Reserved.
 *
...
#define IPF_GRABIT	4	
#define IPF_DROPLOG	5		/* log message of dropped packet  */
#define IPF_ACCEPTLOG	6		/* log message of accepted packet  */
#define IPF_GRABLOG	7		/* log message of grabbed packet  */
