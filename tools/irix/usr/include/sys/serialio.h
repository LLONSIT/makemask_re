...
/* mapping offsets for type USIO_MAP_IOC4 */
#define USIO_MAP_IOC4_DMABUF	0
#define USIO_MAP_IOC4_REG	0x4000

/* id structure for type USIO_MAP_IOC4 */
struct ioc4_mapid {
    int port;
    int size;
};
...
extern int usio_drain(void *);
extern void usio_done(void *);
