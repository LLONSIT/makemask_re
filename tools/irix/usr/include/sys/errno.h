...
#define ENOSERVICE	1503	/* rpc failed, service unknown to server */
#define ENOMESSAGE	1504	/* rpc failed, message unknown to server */
#define ECONVERTING	1505    /* object is in the middle of conversion */
#define ENOBHVHOLD	1056	/* no behavior lock hold */
#define	EINTFDOWN	1507	/* transport interface failure */
#define EEXPORTING	1508	/* object is being exported */
#define EBADOBJID	1510	/* object id is invalid */

/* Miser & cpuset errnos */
#define	EMEMRETRY	1600	/* Retry the system call */
#define ECPUWARN	1601
#define ECPUFAIL	1602
#define EMEMWARN	1603
#define EMEMFAIL	1604
#define ESHAREWARN	1605
#define ESHAREFAIL	1606

/* Job limits errnos */
#define ENOJOB		1700	/* Job id not found or not part of job */
