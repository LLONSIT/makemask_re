...
#if defined(_KERNEL)
#ident	"sys/PCI/pcibr.h: $Revision: 1.62 $"
...
extern void		pcibr_intr_setmustrun(pcibr_intr_t intr, cpuid_t cpu);
...
extern void 		pcibr_pio_flush_del(pcibr_piomap_t);
extern pcibr_piomap_t	pcibr_pio_flush_init(vertex_hdl_t);
extern int 		pcibr_pio_flush_read(pcibr_piomap_t, void *, void *, int);
