 ...
 *									  *
 **************************************************************************/
#ifndef __PCI_PCIIO_H__
#define __PCI_PCIIO_H__
...
typedef iopaddr_t
pciio_dma_addr_f        (vertex_hdl_t dev,	/* translate for this device */
			 device_desc_t dev_desc,	/* device descriptor */
			 paddr_t addr,		/* starting address */
			 size_t byte_count,	/* map this many bytes */
			 pciio_dmamap_t *mapp,	/* in case a dmamap was needed */
			 unsigned flags);

typedef alenlist_t
pciio_dmatrans_list_f   (vertex_hdl_t dev,	/* translate for this device */
			 device_desc_t dev_desc,	/* device descriptor */
...
typedef void
pciio_intr_setmustrun_f       (pciio_intr_t intr_hdl, cpuid_t cpu);
...
typedef void
pciio_pio_flush_del_f (pciio_piomap_t);

typedef pciio_piomap_t
pciio_pio_flush_init_f (vertex_hdl_t);

typedef int
pciio_pio_flush_read_f (pciio_piomap_t, void *, void *, int);
...
typedef struct pciio_provider_s {
    ...
    pciio_pio_flush_del_f  *pio_flush_del;
    pciio_pio_flush_init_f *pio_flush_init;
    pciio_pio_flush_read_f *pio_flush_read;
    ...
    pciio_intr_setmustrun_f      *intr_setmustrun;
    ...
    pciio_config_get_f	   *config_get_safe;
...
extern pciio_dma_addr_f pciio_dma_addr;
...
extern pciio_intr_setmustrun_f pciio_intr_setmustrun;
...
extern pciio_config_get_f pciio_config_get_safe;
...
extern pciio_pio_flush_del_f pciio_pio_flush_del;
extern pciio_pio_flush_init_f pciio_pio_flush_init;
extern pciio_pio_flush_read_f pciio_pio_flush_read;
...
#else /* !USE_PCI_PIO */
static __inline uint8_t pciio_pio_read8(volatile uint8_t *addr)
{ 
	return *addr; 
}
static __inline uint16_t pciio_pio_read16(volatile uint16_t *addr)
{
	return *addr; 
}
static __inline uint32_t pciio_pio_read32(volatile uint32_t *addr)
{
	return *addr; 
}
static __inline uint64_t pciio_pio_read64(volatile uint64_t *addr)
{
	return *addr;
}
static __inline void pciio_pio_write8(uint8_t val, volatile uint8_t *addr)
{
	*addr = val;
}
static __inline void pciio_pio_write16(uint16_t val, volatile uint16_t *addr)
{
	*addr = val;
}
static __inline void pciio_pio_write32(uint32_t val, volatile uint32_t *addr)
{
	*addr = val;
}
static __inline void pciio_pio_write64(uint64_t val, volatile uint64_t *addr)
{
	*addr = val;
}
#endif /* USE_PCI_PIO */
...
extern pciio_slot_t     pciio_info_hostslot_get(pciio_info_t pciio_info);
