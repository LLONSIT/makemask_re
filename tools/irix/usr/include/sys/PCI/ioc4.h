...
#ifndef __PCI_IOC4_H__
#define __PCI_IOC4_H__
...
#if _STANDALONE || IOC4_PIO_MODE
#define IOC4_SIO_IES	        0x010	/* SIO Interrupt Enable Set Reg. */
#define IOC4_OTHER_IES	        0x014	/* Other Interrupt Enable Set Reg. */
#define IOC4_SIO_IEC	        0x018   /* SIO Interrupt Enable Clear Reg */
#define IOC4_OTHER_IEC	        0x01C   /* Other Interrupt Enable Clear Reg */
#else
...
#define IOC4_MISC_CR	        0x024	/* MISC Control Reg */
...
#define IOC4_OTHER_IR_GEN_INTS		0xff000000 /* Generic pins */
...
/* Bitmasks for IOC4_MISC_CR */
#define IOC4_MISC_CR_PCI_SPEED_MASK	0x0000000f /* PCI bus speed */
#define IOC4_MISC_CR_PCI_SPEED_33	0x00000000 /* PCI bus speed 33 MHZ*/
#define IOC4_MISC_CR_PCI_SPEED_66	0x00000001 /* PCI bus speed 66 MHZ*/
...
#define IOC4_GPCR_EDGE	                0x0000ff00 /* Extint edge or level
                                                      sensitive */
#define IOC4_GPCR_EDGE_PIN(x)         (1<<((x)+8)) /* Access one of the EDGE bits */
