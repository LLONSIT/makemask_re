...
typedef volatile struct pci_cfg_s {
	...
	__uint32_t	bar[6];
	__uint32_t	cardbus;
	ushort_t	subsys_dev_id;
	ushort_t	subsys_vendor_id;
	__uint32_t	exp_rom;
	__uint32_t	res[2];
	uchar_t		max_lat;
	uchar_t		min_gnt;
...
typedef volatile struct pci_cfg1_s {
	...
	ushort_t	pmem_limit;
	ushort_t	pmem_base;
	__uint32_t	pmem_limit_upper;
	__uint32_t	pmem_base_upper;
	ushort_t	io_limit_upper;
	ushort_t	io_base_upper;
	__uint32_t	res;
	__uint32_t	exp_rom;
	ushort_t	ppb_control;
	uchar_t		int_pin;
	uchar_t		int_line;
} pci_cfg1_t;
