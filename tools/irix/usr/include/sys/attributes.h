...
#define ATTR_SECURE	0x0008	/* -- unused, from Linux -- */
#define ATTR_CREATE	0x0010	/* pure create: fail if attr already exists */
#define ATTR_REPLACE	0x0020	/* pure set: fail if attr does not exist */
#define ATTR_PARENT	0x0040  /* parent-ptr namespace */
#define ATTR_PARENTPATH	0x0080  /* want the pathnames on attr get */
#define ATTR_SYSTEM	0x0100  /* -- unused, from Linux -- */
#define ATTR_NOLOCKCHK	0x0200  /* no lock or access check on read ops */
#define ATTR_KERNACCESS	0x0400  /* -- unused, from Linux -- */
#define ATTR_KERNORMALS	0x0800  /* -- unused, from Linux -- */
#define ATTR_KERNOTIME	0x1000  /* [kernel] don't update inode timestamps */
#define ATTR_KERNOVAL	0x2000  /* -- unused, from Linux -- */
#define ATTR_KERNAMELS	0x4000  /* -- unused, from Linux -- */
#define ATTR_KERNROOTLS	0x8000  /* -- unused, from Linux -- */

/*
 * Notes for ATTR_KERNOTIME:
