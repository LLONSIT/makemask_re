...
typedef struct { long __D[2]; } pthread_barrierattr_t;	/* barrier attributes */
typedef struct { long __D[16]; } pthread_barrier_t;	/* barrier data */
typedef struct { long __D[4]; } pthread_spinlock_t;	/* spinlock data */
