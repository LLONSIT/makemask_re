...
extern toid_t clock_prtimeout(processorid_t, void (*fun)(), void *,
				  __int64_t, short, ...);
extern __int64_t rtc_read(void);
extern int rtc_resolution(void);
...
/*
 * Kernel thread interface for drivers
 */
extern int drv_thread_create(char * name,
				 ulong_t stack_size,
				 uint_t flags,
				 short pri,
				 st_func_t func,
...
extern void drv_thread_exit(void);
