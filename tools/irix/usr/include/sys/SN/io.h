...
#ifdef SN1
/* This ought to be useful for SN0 too but, for now,
 * make it SN1 only because `ii_ixtt_u_t' is not in SN0/hubio.h
 * (or anywhere else :-).
 */
#if (defined(_LANGUAGE_C) || defined(_LANGUAGE_C_PLUS_PLUS))
/*
 * External interfaces for getting/setting the ixtt register in the hub
 */

extern int hubii_ixtt_get(vertex_hdl_t widget_vhdl, ii_ixtt_u_t *ixtt);
extern int hubii_ixtt_set(vertex_hdl_t widget_vhdl, ii_ixtt_u_t *ixtt);
#endif /* language C/C++ */
#endif /* SN1 */
