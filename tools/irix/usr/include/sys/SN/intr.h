...
typedef struct intr_info_s {
	...
	vertex_hdl_t		ii_owner_dev;	/* device that owns this intr */
...
#if defined(SN0)	/* SN0 compatibility - dont use. Does NOT work on SN1 */
#define REMOTE_HUB_SEND_INTR(_hub, _level) \
		REMOTE_HUB_PI_S((_hub), 0, PI_INT_PEND_MOD, (0x100|(_level)))
#endif
...
#if defined(SN0)	/* SN0 compatibility - dont use. Does NOT work on SN1 */
#define REMOTE_HUB_CLR_INTR(_hub, _level) REMOTE_HUB_PI_CLR_INTR(_hub, 0, _level) 
#endif
