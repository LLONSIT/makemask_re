...
#ifndef __SYS_SN_SN1_HUBNI_NEXT_H__
#define __SYS_SN_SN1_HUBNI_NEXT_H__
...
/*PV 814526  The MAX_BURST reset default is incorrect in NI_PORT_PARMS
  and RR_PORT_PARMS[1-8].  The value is now 842(0x34a) */
/*PV 874199  Marginal clock mismatch (one high, one low) @800MHz
  will produce SN and CB errors with MAX_BURST at 0x320. */
/*PV 914569  Yet another downgrade in the 800 MHz oscillator.
             Lower the MAX_BURST to 0x190 (400). */
#define NPP_MAX_BURST_OVERRIDE_VALUE 0x190
#define NPP_OVER_RESET_DEFAULTS	(0xf << NPP_VCH_ERR_EN_SHFT |   \
				 0x1 << NPP_FIRST_ERR_EN_SHFT | \
				 0x3ff << NPP_MAX_RETRY_SHFT |  \
				 0x6 << NPP_NULL_TIMEOUT_SHFT | \
...
#endif /* __SYS_SN_SN1_HUBNI_NEXT_H__ */
