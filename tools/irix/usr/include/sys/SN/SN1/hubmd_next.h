...
#ifndef __SYS_SN_SN1_HUBMD_NEXT_H__
#define __SYS_SN_SN1_HUBMD_NEXT_H__
...
/*
 * protection and migration are completely revised on SN1.  On
...
#define MD_MIG_DIFF_THRES_VALUE_MASK (UINT64_CAST 0x7fff)
...
#define MD_MIG_VALUE_THRES_VALUE_MASK (UINT64_CAST 0x7fff)
...
#define MD_MIG_CANDIDATE_TYPE_MASK (UINT64_CAST 0x1 << 33)
#define MD_MIG_CANDIDATE_TYPE_SHFT 33
#define MD_MIG_CANDIDATE_OVERRUN_MASK (UINT64_CAST 0x1 << 32)
#define MD_MIG_CANDIDATE_OVERRUN_SHFT 32
#define MD_MIG_CANDIDATE_INITIATOR_MASK (UINT64_CAST 0x7ff << 21)
#define MD_MIG_CANDIDATE_INITIATOR_SHFT 21
#define MD_MIG_CANDIDATE_NODEID_MASK (UINT64_CAST 0xff << 24)
#define MD_MIG_CANDIDATE_NODEID_SHFT 24
#define MD_MIG_CANDIDATE_ADDR_MASK (UINT64_CAST 0x1fffff)
#define MD_MIG_CANDIDATE_ADDR_SHFT 0  /* The address starts at bit 0 */
...
typedef union md_perf_sel {
        __uint64_t      perf_sel_reg;
        struct  {
                __uint64_t      perf_rsvd : 60,
                                perf_en   :  1,
                                perf_sel  :  3;
        } perf_sel_bits;
} md_perf_sel_t;
...
#define MD_MEM_IP45BANKS	4
#define MD_MEM_IP34BANKS	MD_MEM_IP45BANKS
#define MD_MEM_DIMM_BANKS 	4
#define MD_MEM_IP45DIMM_BANKS	2
#define MD_MEM_IP34DIMM_BANKS	MD_MEM_IP45DIMM_BANKS
...
#ifdef BEDROCK_WB_WAR2
/* Enable access from all regions when using the WAR */
#define MD_PDIR_INIT_PROT	0xffffffffffffffff
#else
...
#ifdef BEDROCK_WB_WAR2
#define MD_SDIR_INIT_PROT	0xffffffffffffffff
#else
...
#define MD_PDIR_BISTDATA_MASK   0x00000000ffffffff
#define MD_SDIR_BISTDATA_MASK   0x000000000000ffff
...
#define DIR_ERR_CE_VALID(err)        (err.md_dir_error_fld_s.de_ce_valid)
#define DIR_ERR_UCE_VALID(err)       (err.md_dir_error_fld_s.de_uce_valid)
#define DIR_ERR_AE_VALID(err)        (err.md_dir_error_fld_s.de_ae_valid)
#define DIR_ERR_BAD_SYN(err)         (err.md_dir_error_fld_s.de_bad_syn)
#define DIR_ERR_CE_OVERRUN(err)      (err.md_dir_error_fld_s.de_ce_overrun)
#define MEM_ERR_ADDRESS(err)         (err.md_mem_error_fld_s.me_address)
#define MEM_ERR_CE_VALID(err)        (err.md_mem_error_fld_s.me_read_ce & 1)
#define MEM_ERR_CE_OVERRUN(err)      (err.md_mem_error_fld_s.me_read_ce >> 1)
#define MEM_ERR_BAD_SYN(err)         (err.md_mem_error_fld_s.me_bad_syn)
#define MEM_ERR_UCE_VALID(err)       (err.md_mem_error_fld_s.me_read_uce & 1)
#define MEM_ERR_UCE_OVERRUN(err)     (err.md_mem_error_fld_s.me_read_uce >> 1)
...
#endif /* __SYS_SN_SN1_HUBMD_NEXT_H__ */
