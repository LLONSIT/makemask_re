...
#ifndef __SYS_SN_SN1_HUBLB_NEXT_H__
#define __SYS_SN_SN1_HUBLB_NEXT_H__
...
/* LB_RT_FILTER_CTRL mask and shift definitions */

#define LRFC_ERROR_COUNT_SHFT	48
#define LRFC_ERROR_COUNT_MASK	(UINT64_CAST 0x3ff << 48)
#define LRFC_DROP_THRESH_SHFT	36
#define LRFC_DROP_THRESH_MASK	(UINT64_CAST 0x3ff << 36)
#define LRFC_DROP_COUNT_SHFT	24
#define LRFC_DROP_COUNT_MASK	(UINT64_CAST 0x3ff << 24)
#define LRFC_MASK_ENABLE_SHFT	20
#define LRFC_MASK_ENABLE_MASK	(UINT64_CAST 1 << 20)
#define LRFC_MASK_COUNT_SHFT	8
#define LRFC_MASK_COUNT_MASK	(UINT64_CAST 0xfff << 8)
#define LRFC_OFFSET_MASK	0
#define LRFC_OFFSET_SHFT	(UINT64_CAST 0x1f << 0)
...
#define LNA_GET(_reg, f)	(((_reg) >> (f*LNA_ENTRY_SHFT) & LNA_VALID) ? \
					((_reg) >> (f*LNA_ENTRY_SHFT) & \
					LNA_NODE_MASK) : -1)
...
/* XXX SN1 doesn't support vector exchange:  scr. regs. do locks directly */
...
#endif /* __SYS_SN_SN1_HUBLB_NEXT_H__ */
