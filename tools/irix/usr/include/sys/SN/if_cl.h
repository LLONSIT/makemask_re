...
#ifndef __SYS_SN_IF_CL_H__
#define	__SYS_SN_IF_CL_H__
...
#define   IFCL_ISGROUP(addr)    ((addr)[0] & 01)

#define   IFCL_ADDR_SZ          6

#define   IFCL_ALIASES_SZ      16   /* maximum number of aliases for cl interface */ 
...
#define IFCL_ARP_ALIAS_ADD  0x4   /* send arp request to everyone: add alias to partition */
#define IFCL_ARP_ALIAS_DEL  0x5   /* send arp reply to everyone: delete alias from partition */

/*
 * type of mode for snarp_update()
 */
#define IFCL_PRIMARY      0x0  /* update only primary IP addresss */
#define IFCL_ALIAS_ADD    0x1  /* add alias IP address of interface */
#define IFCL_ALIAS_DEL    0x2  /* delete alias IP address of interface */
...
typedef struct snarptab_s {
    ...
    struct in_addr      snarp_alias_inaddr[IFCL_ALIASES_SZ]; /* aliases */
...
extern int ifcl_ioctl(struct ifnet *, int , void *);
