...
#ifndef	__SYS_SN_SN0_HUBPI_H__
#define	__SYS_SN_SN0_HUBPI_H__
...
#define PI_CC_INTR_ENABLE_ALL	0x0      /* Write this to the mask to enable
                                            all CC interupts.               */
