...
diagval_t diagval_map[] = {
    ...
    {KLDIAG_IOC_BASE_FAIL,     0, 0,
     "Failed to determine IOC3/IOC4 base Address."},
    ...
    {KLDIAG_SER_PIO_FAIL1A,     0, 0,   "Characters already exist on port A"},
    {KLDIAG_SER_PIO_FAIL1B,     0, 0,   "Characters already exist on port B"},
    {KLDIAG_SER_PIO_FAIL1C,     0, 0,   "Characters already exist on port C"},
    {KLDIAG_SER_PIO_FAIL1D,     0, 0,   "Characters already exist on port D"},
    {KLDIAG_SER_PIO_FAIL2A,     0, 0,   "Miscompare on port A"},
    {KLDIAG_SER_PIO_FAIL2B,     0, 0,   "Miscompare on port B"},
    {KLDIAG_SER_PIO_FAIL2C,     0, 0,   "Miscompare on port C"},
    {KLDIAG_SER_PIO_FAIL2D,     0, 0,   "Miscompare on port D"},
    ...
    {KLDIAG_SER_DMA_FAILC,      0, 0,   generic_serdma_fail_str},
    {KLDIAG_SER_DMA_FAILD,      0, 0,   generic_serdma_fail_str},
    ...
    {KLDIAG_RTC_DIST,		0, 0,	"Failed RTC distribution due to NUMAlink problems."},
