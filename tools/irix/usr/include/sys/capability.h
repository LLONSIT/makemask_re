...
#define	CAP_GL_OK		(0x01LL << 45)	/* Iris GL Shim Clients */

#define	CAP_MAX_ID		45
...
extern int cap_exec_newcap( const struct cap_set *, const struct cap_set *, struct cap_set *);
