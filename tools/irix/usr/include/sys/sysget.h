...
#ident "$Id: sysget.h,v 1.22 2003/11/19 02:09:32 dgc.longdrop.melbourne.sgi.com Exp $"
...
#define SGT_NODE_INFO64	34	/* Per node info -- larger values */
#define SGT_RMINFO64	35	/* real memory info - 64 bit version */
#define SGT_MINFO64	36	/* Larger version of minfo */
#define SGT_BUFTHROTTLE	37	/* buffer cache throttle info */
#define SGT_TCPIPSTATS2	38	/* extended TCP/IP stats (superset of
					SGT_TCPIPSTATS) */
#define	SGT_MAX		38	/* Max entries, >>End-of-Table<< */
