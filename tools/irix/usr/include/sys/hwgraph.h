...
/* Hwgraph groups are divided into 16 buckets.  Could make this tunable if
 * needed. */
#define HWGRAPH_NUM_BUCKETS	16
...
extern void hwgraph_inventory_access(void);
extern void hwgraph_inventory_unaccess(void);
