 ...
 *									  *
 **************************************************************************/
#ifndef __XTALK_XTALK_H__
#define __XTALK_XTALK_H__
...
typedef cpuid_t
xtalk_intr_cpuid_get_f    (xtalk_intr_t intr_hdl);	/* xtalk intr resource handle */
...
typedef struct xtalk_provider_s {
    ...
    xtalk_intr_cpuid_get_f   *intr_cpuid_get;
...
extern xtalk_intr_cpuid_get_f xtalk_intr_cpuid_get;
...
extern cpuid_t	        xtalk_intr_cpuid_get(xtalk_intr_t xtalk_intr);
...
extern int		xtalk_device_powerup(vertex_hdl_t, xwidgetnum_t);
extern int		xtalk_device_shutdown(vertex_hdl_t, xwidgetnum_t);
extern int		xtalk_device_inquiry(vertex_hdl_t, xwidgetnum_t);

#else /* not _KERNEL */

/*
 * `dummy' typedefs to allow libc to build. PV 808114
 */

typedef void
xwidget_intr_preset_f   (void *,
                         int ,
                         int ,
                         int ,
                         int );
