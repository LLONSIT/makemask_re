 ...
 *									  *
 **************************************************************************/
#ifndef __XTALK_XBOW_H__
#define __XTALK_XBOW_H__
...
/* determine the other port number potentially connected to a hub/bedrock */
#ifdef SN1
# define XBOW_HUBLINK_LOW  0xa
# define XBOW_HUBLINK_HIGH 0xb
#else
# define XBOW_HUBLINK_LOW  0x9
# define XBOW_HUBLINK_HIGH 0xa
#endif
...
#ifdef SABLE
#define XBOW_WIDGET_PART_NUM	0xc111		/* crossbow */
#define XXBOW_WIDGET_PART_NUM	0xc112		/* Xbridge */  /* FIXME */
...
typedef union xbw0_cmdword_u {
    xbowreg_t               cmdword;
    struct {
	__uint32_t              destid:4,	/* Desination ID number         */
...
typedef union xbw0_status_u {
    ...
    struct {
	__uint32_t              linkXintr:8,	/* link(x) error intr */
	                        wid0intr:1,	/* Widget 0 err intr */
	                        resvd1:13, 
                                src_id:4,	/* source id. Xbridge only */
				regacc_err:1,	/* Reg Access error     */
				/* Xbridge only */
				w0_recv_tout:1,	/* receive timeout err */
				w0_arb_tout:1,	/* arbiter timeout err */
				/* End of Xbridge only */
...
typedef union xbow_linkctrl_u {
    ...
    struct {
	__uint32_t              alive_intr:1, rsvd1:1, perf_mode:2,
	                        inbuf_level:3, send_bm8:1, force_badllp:1,
	                        llp_credit:5, idest_intr:1, obuf_intr:1,
	                        rsvd2:7, bwalloc_intr:1, rcvov_intr:1,
	                        trxov_intr:1, trx_max_retry_intr:1,
	                        rcv_err_intr:1, trx_retry_intr:1, rsvd3:1,
	                        maxto_intr:1, srcto_intr:1;
    } xb_linkcontrol;
} xbow_linkctrl_t;
...
typedef union xbow_perf_count_u {
    ...
    struct {
	__uint32_t              rsvd:9, link_select:3, count:20;
    } xb_perf;
} xbow_perfcount_t;
...
#ifdef SN1
extern int xbow_barrier(xbow_t *, int, int);
#endif
...
#else
extern xbowreg_t print_xbow_status(__psunsigned_t, int);
#endif
