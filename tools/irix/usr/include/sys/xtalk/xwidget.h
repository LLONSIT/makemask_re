...
/*
 * Set SN default LLP maxburst to 0x3e0.   Maxburst is the max number of
 * micropackets that can be sent across the link before the
 * two sides sync up.  The default value of 0x10 is well below
 * the tolerances of SN0/SN1 systems. (as per Steve Miller)
 */
#define WIDGET_LLP_MAXBURST_SN		0x3e0
