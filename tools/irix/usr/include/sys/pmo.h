...
#define PMO_ASMIGRATE          41
#define PMO_ASMIGRATECLOSE     42
...
#if defined(SN) && (!defined(SN0) || defined(SN0XXL))
/*
...
/*
 *    flag to control inheritance of the page size across exec.
 */
#define POLICY_INHERIT_MEM_DATA		0x080
...
int __pm_get_page_info(void *base_addr, size_t length, pm_pginfo_t* pginfo_buf,
                       int buf_len);
