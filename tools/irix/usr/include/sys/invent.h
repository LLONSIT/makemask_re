 ...
 * $Revision: 1.326 $
 *
 * Copyright 1988-2005, Silicon Graphics, Inc.
 * All Rights Reserved.
 *
...
#define INV_QL_2310	25	/* qLogic 2310 Fibrechannel */
#define INV_QL_2342A	26	/* qLogic 2342 (a.k.a. qLogic 2312) Fibrechannel - Port 1 */
#define INV_QL_2342B	27	/* qLogic 2342 (a.k.a. qLogic 2312) Fibrechannel - Port 2 */
#define INV_QL_2340	28	/* qLogic 2340 Fibrechannel */
#define INV_IDE_IOC4	29	/* IDE (ATA/ATAPI) part of IOC4 */
#define INV_LS_1030	30	/* LSI 1030 dual port u320 scsi pcix board */
#define INV_LS_929XA	31	/* LSI 929 dual port 2 gb FC pcix Port 0 */
#define INV_LS_929XB	32	/* LSI 929 dual port 2 gb FC pcix Port 1 */
#define INV_LS_949XA	33	/* LSI 949 dual port 4 gb FC pcix Port 0 */
#define INV_LS_949XB	34	/* LSI 949 dual port 4 gb FC pcix Port 1 */
#define INV_LS_939X	35	/* LSI 939 single port 4 gb FC pcix */
#define INV_LS_1064	36	/* LSI 1064 4 port SAS/SATA pcix board */
#define INV_LS_1068	37	/* LSI 1068 8 port SAS/SATA pcix board */
...
#define INV_XVMPRIVATE	0x1000	/* disk is an XVM private disk */
#define INV_XVMCLUSTER	0x2000	/* disk is an XVM cluster disk */
#define INV_XVMFOREIGN	0x4000	/* disk is foreign to this host or cluster */

#define INV_FO_PREFERRED_PATH	0x00008000      /* preferred i/o path */
#define INV_FO_AFFINITY		0x000f0000      /* used to associate paths to raid controllers */
#define INV_FO_AFFINITY_SHIFT		16
#define INV_FO_MAX_AFFINITY	((INV_FO_AFFINITY) >> (INV_FO_AFFINITY_SHIFT))
...
/* states for INV_SCSI type of class processor */
#define INV_CPU_SCANNER 1       /* Scanners labelled as processor devices */

/* units for INV_QL_2200, INV_QL_23XX states */
#define INV_PCI_33MHZ           0       /* PCI 33 MHz    */
#define INV_PCI_66MHZ           1       /* PCI 66 MHz    */
#define INV_PCIX_66MHZ          2       /* PCI-X 66 MHz  */
#define INV_PCIX_100MHZ         3       /* PCI-X 100 MHz */
#define INV_PCIX_133MHZ         4       /* PCI-X 133 MHz */
...
#define INV_IOC4_DMA	20	/* DMA mode IOC4 serial */
#define INV_IOC4_PIO	21	/* PIO mode IOC4 serial */
...
#define TPSTK9940       33      /* StorageTeK 9940 */
#define TPAPD		34	/* First Async PD Device */
#define TPLTO		35	/* Linear Tape-Open Device */
#define TPGY8240	36      /* Sony GY-8240 */
#define TPSAIT		37	/* Sony SAIT Device */
#define TPIBM3592	38	/* IBM 3592 Device */
#define TPTITANIUM	39	/* STK Titanium Device */
#define TPAPDLAST	69	/* Last Async PD Device */
...
#define INV_IR4		23	/* InfiniteReality4 graphics */
#define INV_PCIGFX      24      /* SG2 graphics */
#define INV_PCIGVO_DM7  25      /* Rainier PCI-Graphics to Video Out option card */
#define INV_PCIVGA      26      /* VGA textport */
#define INV_IS1		27      /* IS1 card */
...
#define	INV_ETHER_GE	28	/* Tigon2 Gigabit Ethernet */
...
#define INV_MYRINET     36	/* Myricom PCI network */
#define	INV_NET_GENERIC 37  /* "Generic" network driver, with hinv output
                             * found in labelled attribute attached to
                             * the hwgraph vertex specified in inv_state
                             * field */
...
#define INV_AUDIO_USB		6	/* USB audio device */
#define INV_AUDIO_MAD		7	/* MAD PCI audio interface */
#define INV_AUDIO_EMU		8	/* EMU PCI audio interface */
...
#define INV_VIDEO_SD_ANAVID	17      /* PCI SD Analog Video */
#define INV_VIDEO_SGC		18      /* PCI DVI Capture */

#define INV_VIDEO_MPEG_2K1	20	/* Skymicro Merlin 2K1 */
#define INV_VIDEO_MPEG_2K2	21	/* Skymicro Merlin 2K2 */

#define INV_VIDEO_IIDC		40	/* IIDC Video */
#define INV_VIDEO_AVC		41	/* AV/C Video */

#define INV_VIDEO_DVBASI_MP503	0x75	/* Viewgraphics Dynamo mp503 */
#define INV_VIDEO_DVBASI_VP	0x76	/* Video propulsion dvb asi card */
...
#define INV_MISC_IOC4_EINT	4	/* IOC4 external interrupts */
#define INV_MISC_IOC4		7	/* misc. IOC4 info */
...
#define INV_DM10                1       /* DM10 IEEE1394 pci option card */
...
#define INV_TPUPLUS_XIO		2	/* Internal XIO Tensor Processing Unit Plus */
...
#define USB_INV_CLASS_COMPOSITOR 0xff	/* graphics compositor device */
...
#define USB_INV_HID_TABLET	0x03	/* tablet (HID class) */
...
extern int	    xscaninvent(int (*)(inventory_t *, vertex_hdl_t, void *), 
				void *);
...
extern int device_inventory_string_set( dev_t device,
                                        char *string);

extern int device_inventory_string_remove( dev_t device);
