...
#if _XOPEN4UX || _XOPEN5 || defined(_BSD_TYPES) || defined(_BSD_COMPAT)
/*
...
{
	return __xpg4_select(_nfds, _readfds, _writefds, _exceptfds, _timeout);
}
...
#ifndef utimets
/* can't use #pragma optional is utimets() has been cpp aliased */
