...
/* Used by dm_clrmount_callback */
enum dm_clr_flag {
	DM_ADD_CLRMOUNT,
	DM_REMOVE_CLRMOUNT
};
typedef enum dm_clr_flag dm_clr_flag_t;
#define HAVE_DM_CLRMOUNT 1
...
extern int
dm_clrmount_callback(
	dm_sessid_t	sid,
	dm_clr_flag_t	clrflag);

#ifndef _KERNEL
#pragma optional dm_clrmount_callback
#endif
