/*
 *    Unpublished copyright (c) 1995-1997,2000 Silicon Graphics, Inc.
...
#ifdef SN0
extern int setgsnsched_thread(thread_handle_t);
extern void cleargsnsched_thread(thread_handle_t);
extern int is_gsn_bypass_thread(thread_handle_t);
#endif
...
extern void  kabi_free_pages(paddr_t *, pgcnt_t);
