...
#define	XFS_FS_GEOMETRY_V3	8	/* get filesystem geometry>=irix6.5.3 */
#define	XFS_FS_GOINGDOWN	9	/* mark goingdown */
#define	XFS_FS_FREEZE		10	/* freeze new access */
#define	XFS_FS_THAW		11	/* restart accesses */
#define	XFS_FS_GEOMETRY		12	/* get filesystem geometry>=irix6.5.26 */
#define	XFS_FSOPS_COUNT		13	/* count of operations */
...
typedef struct xfs_fsop_geom
{
	...
	__uint32_t	logsunit;	/* log stripe unit, bytes */
} xfs_fsop_geom_t;
...
#define	XFS_FSOP_GEOM_FLAGS_ATTR2	0x400	/* inline attributes rework */
#define	XFS_FSOP_GEOM_FLAGS_DIRV2CI	0x1000	/* dir2 case-insenstitive names */
#define	XFS_FSOP_GEOM_FLAGS_MMR		0x2000	/* Multiple managed regions */
#define	XFS_FSOP_GEOM_FLAGS_LAZYSB	0x4000	/* lazy superblock counters */
#define	XFS_FSOP_GEOM_FLAGS_PARENT	0x8000  /* parent pointers */

/*
 * This version has five new fields:
 *	version, flags, logsectsize, rtsectsize, dirblocksize 
 * Added in Irix 6.5.3
 */
typedef struct xfs_fsop_geom_v3
{
	__uint32_t	blocksize;	/* filesystem (data) block size */
	__uint32_t	rtextsize;	/* realtime extent size */
	__uint32_t	agblocks;	/* fsblocks in an allocation group */
