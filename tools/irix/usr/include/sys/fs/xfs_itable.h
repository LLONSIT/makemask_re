...
#define XFS_XFLAG_HASATTR	0x80000000L	/* no DIFLAG for this */
#define XFS_XFLAG_ALL          \
	( XFS_XFLAG_REALTIME|XFS_XFLAG_PREALLOC|XFS_XFLAG_IMMUTABLE|	\
	  XFS_XFLAG_APPEND|XFS_XFLAG_SYNC|XFS_XFLAG_NOATIME|		\
	  XFS_XFLAG_NODUMP|XFS_XFLAG_RTINHERIT|XFS_XFLAG_PROJINHERIT|	\
	  XFS_XFLAG_NOSYMLINKS|XFS_XFLAG_EXTSIZE|XFS_XFLAG_EXTSZINHERIT|\
	  XFS_XFLAG_HASATTR)
 ...
 * see xfs_bulkstat_one() and xfs_dm_bulkstat_one() in xfs_dmapi.c
 */
