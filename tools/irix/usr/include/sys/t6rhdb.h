...
extern int t6rhdb_put_host6(size_t, caddr_t, rval_t *);
extern int t6rhdb_get_host6(struct in6_addr *, size_t, caddr_t, rval_t *);
extern int t6rhdb_flush6(struct in6_addr *, rval_t *);
extern void t6rhdb_init(void);
extern int t6findhost(struct in_addr *, int, t6rhdb_kern_buf_t *);
extern int t6findhost6(struct in6_addr *, int, t6rhdb_kern_buf_t *);
#else
...
int t6rhdb_put_host6(size_t, caddr_t);
int t6rhdb_get_host6(struct in6_addr *, size_t, caddr_t);
int t6rhdb_flush6(const struct in6_addr *);

#if !defined(_SGI_COMPILING_LIBC)
#pragma optional t6rhdb_put_host6
#pragma optional t6rhdb_get_host6
#pragma optional t6rhdb_flush6
