/**************************************************************************
 *									  *
 * 		 Copyright (C) 1986-2003 Silicon Graphics, Inc.		  *
 *									  *
...
#ifndef _SYSSGI_PLATFORM_COMMON
#include <sys/types.h>
...
#define SGI_ACL_ACCESS		93	/* Check Access Control List(s) */
...
#define SGI_AUTOFS_SYS		170	/* AutoFS system call */
...
#define	SGI_FAST_XPMEM_COPY	196	/* SGI internal use only */
...
/*
 * This call provides brick serial numbers (as distinct from the
 * system serial number) for SN systems.
 */
#define SGI_BRICK_INFO          198

/*
 * Internal Only: Get the handler name for an xthread
 */
#define SGI_GET_HANDLER_NAME	199
...
#define	SGI_FS_SWAPEXT  	229	/* xfs swap extents for defrager */
...
#define SGI_FORMAT_MODULE_NUM	234	/* format a module number to a string */
#define SGI_PARSE_MODULE_NUM	235	/* parse a string to a module number */
#define SGI_IPC_AUTORESERV_SHM  236	/* is IPC_AUTORESERV present? */

#define SGI_SENDFILE		250	/* sendfile for sgi samba */
...
#define SGI_XFS_GETPARENTS	365	/* get the XFS parent ino#s of an inode */
#define SGI_XFS_GETPARENTPATHS	366	/* get the XFS parent paths of an inode */

#define SGI_FO_DUMP             400	/* failover dump */
#define SGI_FO_SWITCH           401	/* failover switch */
...
#define SGI_FO_TRESSPASS	407	/* failover switch/tresspass */

#define SGI_SCSI_CTLR_START_NUM	408	/* where ioconfig should start numbering scsi */

#define SGI_FO_GET_MAX_PATHS	409	/* return max failover paths */

#define	SGI_HBA_GET_NUM_HBA	410	/* get number of hbas supporting fc-hba api */
#define	SGI_HBA_GET_HBA_NAME	411	/* return the name of a particular hba */

#endif /* !_SYSSGI_PLATFORM_COMMON */

#define SGI_XVM_OPS		501	/* XVM user-initiated operations */
 ...
 *	CSA accounting
 */
#define SGI_ACCTCTL		600	/* CSA accounting config requests,  */
					/* daemon and ja accounting */
/*
 * Initial floating point evironment
 */
#define SGI_FPC_INITSTATE	650
...
/* allow all future auto-placed mmap and shmat calls to use
 * the reserved range between 0x30000000 and
 * 0x40000000 if needed.  This option is inherited across fork/exec.
 */

#define SGI_UNSUPPORTED_MAP_RESERVED_RANGE 1054
#endif /* !_SYSSGI_PLATFORM_COMMON */

/* SGI_XVM_OPS suboptions - ADD TO THE END ONLY!!! - DON'T CHANGE ORDER */
enum xvm_sgi_ops_e {
	SGI_XVM_INIT_LOCAL,		/* Initialize private disks */
	SGI_XVM_GET_HOST_NAME,		/* Retrieve node name */
	SGI_XVM_ENABLE_MIRRORS,		/* Enable/disable mirrors */
	SGI_XVM_ENABLE_SNAPSHOT,	/* Enable/disable snapshot */
	SGI_XVM_ENABLE_USER,	        /* Enable/disable user */
	SGI_XVM_END
};
...
#ifndef _SYSSGI_PLATFORM_COMMON
/*
 * NFS unmount -- used only by autofs. This is internal only.
 */
#define SGI_NFS_UNMNT           1061

/*
 * NFS generic interface. This is internal only.
 */
#define SGI_NFS_GENERIC_CMD     1062
/* ONC RPC generic interface, internal only */
#define SGI_ONCRPC_CMD		1063
/* Fill nfs_args, used by nfsstat, requires CAP_MOUNT_MGT, internal only */
#define SGI_GETNFSARGS		1064
/* Enable program to be served by the kernel NFSD, requires
 * CAP_NETWORK_MGT, internal interface */
#define SGI_SWITCH_NFSPROG	1065
/* Update NSM status, requires CAP_NETWORK_MGT, internal interface */
#define SGI_NSM_CNTL		1066
 ...
 *  job related items.
 */
#define SGI_GETJLIMIT		 1210
#define SGI_SETJLIMIT		 1211
#define SGI_GETJUSAGE		 1212
#define SGI_SETJUSAGE		 1213
#define SGI_GETJID		 1214
#define SGI_KILLJOB		 1215
#define SGI_MAKENEWJOB		 1216
#define SGI_GETJOBPID		 1217
#define	SGI_JOINJOB		 1218
#define	SGI_SETWAITJOBPID	 1219
#define	SGI_WAITJOB		 1220

/* values for alternate job operations that take jid_t * rather than jid */
#define SGI_GETJUSAGE_ALT	 1231
#define SGI_GETJLIMIT_ALT	 1232
#define SGI_SETJLIMIT_ALT	 1233
#define SGI_MAKENEWJOB_ALT	 1234
#define SGI_KILLJOB_ALT		 1235
#define	SGI_JOINJOB_ALT		 1236
#define SGI_GETJOBPID_ALT	 1237
#define	SGI_SETWAITJOBPID_ALT	 1238

/*
 *  Miscellaneous platform functions.
 */
#define	SGI_IP30MISC		1250		/* get heart/xbow revision */

/*
 * Syslog opening flags functions
 *
 */
#define	SGI_GET_SYSLOG_LOGOPT	1260		/* Used by libc vsyslog() */
...
/*
 * range from 0x2000 - 0x2200 reserved for internal debug purposes
 */
#define       SGI_DEBUG_L2_ILT        0x2001
#define       SGI_DEBUG_MEMSCAN       0x2002
#define       SGI_DEBUG_MDCONFIG      0x2003
#define       SGI_DEBUG_MDREFRESH     0x2004
...
#define SGICONST_SCACHE_SETASSOC 5	/* Secondary cache set associativity */
#define SGICONST_SCACHE_SIZE     6	/* Secondary cache size */
...
/* SGI Use Only */
/* Structure used by hinv, on IP30's only, to extract the heart ASIC
 * and xbow ASIC revision numbers.
 */
struct	sgi_ip30misc {
	__int32_t	xbow_revision;		/* xbow revision number */
	__int32_t	heart_revision;		/* heart revision number */
};
