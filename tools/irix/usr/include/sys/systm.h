...
#if !_STANDALONE
extern void	clean_icache(void *, unsigned int, pfn_t, unsigned int);
extern void	clean_dcache(void *, unsigned int, pfn_t, unsigned int);
#endif /* _STANDALONE */
extern void	cacheinit(void);
extern void	bclean_caches(void *, unsigned int, unsigned int, unsigned int);
extern void	_bclean_caches(void *, unsigned int, pfn_t, unsigned int);
...
extern int	remapfile(struct vnode *, off_t, int);
