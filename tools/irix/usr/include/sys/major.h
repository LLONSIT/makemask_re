...
#define DEVPOLL_MAJOR	138	/* /dev/poll */
...
#define XVM_MAJOR	268	/* XVM logical volume manager driver */
#define VXIO_MAJOR      269     /* Veritas Volume Manager VXIO Driver*/
#define VXSPEC_MAJOR    270     /* Veritas Volume Manager VXSPEC Driver */
#define VXTED_MAJOR     271     /* Veritas Volume Manager TED Driver */
#define VXDMP_MAJOR     272     /* Veritas Volume Manager DMP Driver */
