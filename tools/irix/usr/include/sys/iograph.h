#ifndef __SYS_IOGRAPH_H
#define __SYS_IOGRAPH_H
...
#define EDGE_LBL_FIREWIRE		"firewire"	/* For Firewire */
...
#define EDGE_LBL_L1_1			"L1_extern"
...
#define EDGE_LBL_NBRICK			"Nbrick"
#define EDGE_LBL_CGBRICK		"CGbrick"
#define EDGE_LBL_CPUBUS			"cpubus"	/* CPU Interfaces (SysAd) */
#define	EDGE_LBL_MEM_ALLOC		"mem_alloc"	/* BDS server mem allocator */
...
#define INFO_LBL_HINV_STRING    "_hinv_string"  /* string to be displayed by hinv */
...
#define	INFO_LBL_ENET_OPEN_FUNC		"_enet_open_f"	/* enet open function
							 * to call early for
							 * diskless */
...
/*
 * Map a brick's widget number to a meaningful int (ie. the brick bus#)
 */
