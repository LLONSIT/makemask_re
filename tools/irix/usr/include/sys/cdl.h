...
typedef void	
cdl_drv_f		(vertex_hdl_t vhdl, int key1, int key2, int error);
...
async_attach_t  async_attach_get_info(vertex_hdl_t);
void            async_attach_add_info(vertex_hdl_t, async_attach_t);
void            async_attach_del_info(vertex_hdl_t);
