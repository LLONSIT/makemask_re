...
#define		RT_GQ(kt)	(cpusets[(kt)->k_cpuset].cs_rt_gq)
#define		GQLOCK(kt)	(cpusets[(kt)->k_cpuset].cs_gqlock)
#define		CPU_RT_GQ	(cpusets[cpu_to_cpuset[cpuid()]].cs_rt_gq)
#define		CPU_GQLOCK	(cpusets[cpu_to_cpuset[cpuid()]].cs_gqlock)
#define		GLOBAL_RT_GQ	(global_cpuset.cs_rt_gq)
#define		GLOBAL_GQLOCK	(global_cpuset.cs_gqlock)
