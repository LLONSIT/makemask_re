...
#define RTMON_CXFS		0x0000000000004000LL	/* CXFS vops & tokens */
/*
...
#define	TSTAMP_CPUTYPE_R14000	55	/* CPU */
#define	TSTAMP_CPUTYPE_R16000	56	/* CPU */
#define	TSTAMP_CPUTYPE_R18000	57	/* CPU */
#define TSTAMP_CPUTYPE_RM7000	58	/* CPU */
...
#define VM_LOG_TSTAMP_EVENT(evt, (int64_t) qual0, (int64_t) qual1, (int64_t) qual2, (int64_t) qual3) ;
...
#define SCHED_EVENT_PRI_INHERIT	KERNEL_EVENT(205)
#define SCHED_EVENT_PRI_DEINHERIT	KERNEL_EVENT(206)
...
/*
 * CXFS Token events - reserved KERNEL_EVENT(500) through KERNEL_EVENT(599)
 */
#define CXFS_EVENT_BASE			KERNEL_EVENT(500)
#define CXFS_VOP_BASE			KERNEL_EVENT(550)
/* vnode ops */
#define CXFS_VOPEN			(CXFS_VOP_BASE+0)
#define CXFS_VCOVER	 		(CXFS_VOP_BASE+1)
#define CXFS_VREAD			(CXFS_VOP_BASE+2)
#define CXFS_VWRITE			(CXFS_VOP_BASE+3)
#define CXFS_VGETATTR 			(CXFS_VOP_BASE+4)
#define CXFS_VSETATTR 		 	(CXFS_VOP_BASE+5)
#define CXFS_VCREATE 			(CXFS_VOP_BASE+6)
#define CXFS_VREMOVE 			(CXFS_VOP_BASE+7)
#define CXFS_VMKDIR 			(CXFS_VOP_BASE+8)
#define CXFS_VRMDIR 			(CXFS_VOP_BASE+9)
#define CXFS_VREADDIR 			(CXFS_VOP_BASE+10)
#define CXFS_VSYMLINK 			(CXFS_VOP_BASE+11)
#define CXFS_VREADLINK 			(CXFS_VOP_BASE+12)
#define CXFS_VINACTIVE 			(CXFS_VOP_BASE+13)
#define CXFS_VRWLOCK 			(CXFS_VOP_BASE+14)
#define CXFS_VRWUNLOCK 			(CXFS_VOP_BASE+15)
#define CXFS_VALLOCSTORE 		(CXFS_VOP_BASE+16)
#define CXFS_VFCNTL 			(CXFS_VOP_BASE+17)
#define CXFS_VRECLAIM 			(CXFS_VOP_BASE+18)
#define CXFS_VLINK_REMOVED 		(CXFS_VOP_BASE+19)
#define CXFS_VVNODE_CHANGE 		(CXFS_VOP_BASE+20)
#define CXFS_VFLUSHINVAL_PAGES 		(CXFS_VOP_BASE+21)
#define CXFS_VFLUSH_PAGES 		(CXFS_VOP_BASE+22)
#define CXFS_VPAGES_SETHOLE 		(CXFS_VOP_BASE+23)
#define CXFS_VATTR_SET 			(CXFS_VOP_BASE+24)
#define CXFS_VFRLOCK 			(CXFS_VOP_BASE+25)
#define CXFS_VREADBUF			(CXFS_VOP_BASE+26)
#define CXFS_VIOCTL			(CXFS_VOP_BASE+27)
#define CXFS_VCLOSE			(CXFS_VOP_BASE+28)
#define CXFS_VACCESS			(CXFS_VOP_BASE+29)
#define CXFS_VATTR_GET			(CXFS_VOP_BASE+30)
#define CXFS_VATTR_REMOVE		(CXFS_VOP_BASE+31)
#define CXFS_VATTR_LIST			(CXFS_VOP_BASE+32)
#define CXFS_VBMAP			(CXFS_VOP_BASE+33)
#define CXFS_VLINK			(CXFS_VOP_BASE+34)
#define CXFS_VRENAME			(CXFS_VOP_BASE+35)
#define CXFS_VFID			(CXFS_VOP_BASE+36)
#define CXFS_VFID2			(CXFS_VOP_BASE+37)
#define CXFS_VFSYNC			(CXFS_VOP_BASE+38)
#define CXFS_VSEEK			(CXFS_VOP_BASE+39)
#define CXFS_VFRLOCK2			(CXFS_VOP_BASE+40)
#define CXFS_VSTRATEGY			(CXFS_VOP_BASE+41)
#define CXFS_VLOOKUP			(CXFS_VOP_BASE+42)

/* Token operations */
#define CXFS_TK_ACQUIRE			(CXFS_EVENT_BASE+0)
#define CXFS_TK_RELEASE			(CXFS_EVENT_BASE+1)
#define CXFS_TK_ACQUIRE_COND		(CXFS_EVENT_BASE+2)
#define CXFS_TK_OBTAINING		(CXFS_EVENT_BASE+3)
#define CXFS_TK_HOLD			(CXFS_EVENT_BASE+4)
#define CXFS_TK_RETURN			(CXFS_EVENT_BASE+5)
#define CXFS_TK_ITERATE			(CXFS_EVENT_BASE+6)
#define CXFS_TK_LEND			(CXFS_EVENT_BASE+7)
#define CXFS_TK_LENT			(CXFS_EVENT_BASE+8)
#define CXFS_TK_OBTAINED		(CXFS_EVENT_BASE+9)
#define CXFS_TK_ACQUIRE_SPEC		(CXFS_EVENT_BASE+10)
