...
/*
 * Get the starting pfn of a large page of size (size) from supplied (pfn)
 */
#define pfn_to_large_pfn(pfn,size)  ((pfn) & (~((size) - 1)) )
...
#if defined(IP35) || defined(IP27) || defined(IP25) || defined(IP19)
...
extern void collect_node_info(struct nodeinfo64 *);
