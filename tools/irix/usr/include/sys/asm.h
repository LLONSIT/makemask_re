...
#if (defined(_COMPILER_VERSION) && (_COMPILER_VERSION >= 741))
#define SAVE_RA	.save ra
#define RESTORE_RA .restore ra
#else
#define SAVE_RA
#define RESTORE_RA
#endif
...
/* RM5271 code hazard nop defs (O2 only) */
#ifdef RM5271
#define RM5271_NOP_1	nop
#define RM5271_NOP_2	nop; nop
#else
#define RM5271_NOP_1
#define RM5271_NOP_2
#endif

/* RM7000 code hazard nop defs (O2) */
#ifdef RM7000
#define RM7000_NOP_2	nop; nop
#else
#define RM7000_NOP_2
#endif
