...
#define ldl_op          0x1A
#define ldr_op          0x1B
/* The SPECIAL2 major opcode is new in the MIPS32 and MIPS64 ISAs. */
#define spec2_op	0x1C
#define mdmx_op		0x1E	/* major opcode for MDMX instructions */
...
/* func field of spec2 opcode -- MIPS32 / MIPS64 */
#define clz_op		0x20
#define clo_op		0x21
#define dclz_op		0x24
#define dclo_op		0x25
#define sdbbp_op	0x3f	/* MIPS EJTAG */
...
#define ctc_op		0x06
#define bc_op		0x08
#define bcany2_op	0x09	/* MIPS-3D ASE; defined for coprocessor 1 */
#define bcany4_op	0x0a	/* MIPS-3D ASE; defined for coprocessor 1 */
#define cop_op		0x10
#define copm_op         0x18
...
#define rfe_op		0x10
#define eret_op		0x18
#define deret_op	0x1f	/* MIPS EJTAG */
#define wait_op		0x20	/* MIPS32 / MIPS64 */
...
/* MIPS-3D ASE instructions */
#define faddr_op	0x18
#define fmulr_op	0x1a
#define frecip1_op	0x1d
#define frecip2_op	0x1c
#define frsqrt1_op	0x1e
#define frsqrt2_op	0x1f
...
const
  ...
  ldl_op =	16#1A;
  ldr_op =	16#1B;
  /* The SPECIAL2 opcode is new in the MIPS32 and MIPS64 ISAs. */
  spec2_op =	16#1C;
  mdmx_op =	16#1E;	/* major opcode for MDMX instructions */
  ...
  ctc_op =	16#06;
  bc_op =	16#08;
  bcany2_op =	16#09;	/* MIPS-3D ASE; defined for coprocessor 1 */
  bcany4_op =	16#0a;	/* MIPS-3D ASE; defined for coprocessor 1 */
  cop_op =	16#10;
  copm_op =	16#18;
  ...
  rfe_op =	16#10;
  eret_op =	16#18;
  deret_op =	16#1f;	/* MIPS EJTAG */
  wait_op =	16#20;	/* MIPS32 / MIPS64 */
