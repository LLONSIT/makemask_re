...
#define	PDA_IS_R12000		((private.p_cputype_word >> C0_IMPSHIFT) \
							== C0_IMP_R12000)
#define	PDA_IS_R14000		((private.p_cputype_word >> C0_IMPSHIFT) \
							== C0_IMP_R14000)
...
/* 
 * Following are the various kinds of events tat can be counted in the R12K/R12KS/R14K
 * performance counters.
 */
...
extern void hwperf_set_counters(cpu_mon_t *, hwperf_cntr_t *, int *);
