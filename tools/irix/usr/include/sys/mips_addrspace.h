...
#define	K0BASE		0x9600000000000000
#define	CACHEOP_K0BASE	0xa800000000000000	/* Cacheops use cached addrs */
#else
#define	K0BASE		0xa800000000000000
#define	CACHEOP_K0BASE	K0BASE
#endif
...
#if (defined(EVEREST) || defined(SN)) && !defined(_STANDALONE)
/*
