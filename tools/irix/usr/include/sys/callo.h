...
/* max value of c_cid at 22 bits (corresponds to c_pid struct def above) */
#define MAX_C_CID 4194303
#else
/* max value of c_cid at 24 bits */
#define MAX_C_CID 16777215 
#endif
 ...
 *   The start of this struct needs to match that of ci_stack.
 */
struct callout {
...
extern short callout_get_pri(void);
