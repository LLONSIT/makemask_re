...
#ident  "$Id: tpuerrno.h,v 1.6 2002/05/24 19:45:34 letsche Exp $"
...
#define TPU_FPIN_PERM	19		/* Process lacks capability to use f_pinned mode */
#define TPU_ASY_ERR	20		/* Asynchronous xtalk error (via xwidget_error) */
#define TPU_NOT_CACHED	21		/* virtual address not found in virtual->physical address cache */

#define	TPU_ERR_MAX	21		/* maximum status code value */
...
static const struct {
	...
	{TPU_FPIN_PERM,		EPERM,		"Process lacks capability to use f_pinned mode"},
	{TPU_ASY_ERR,		EIO,		"Asynchronous xtalk error (xwidget_error)"},
	{TPU_NOT_CACHED,	EFAULT,	"Address not found in virtual->physical address cache"}
	};
