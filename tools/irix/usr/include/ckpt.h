...
#define	CKPT_REVISION_13	4	/* CPR Rev 1.3 */
#define	CKPT_REVISION_CURRENT	CKPT_REVISION_13
...
#define	P_JID		13	/* checkpoint IRIX job */
...
#define	CKPT_JOB	P_JID

#define CKPT_IS_JOB(t)		(CKPT_REAL_TYPE(t) == CKPT_JOB)
...
#define	CKPT_RESTART_MIGRATE	      0x40    /* Migrate memory at restart */
#define CKPT_ATTRFILE_IN_CWD          0x80    /* Use .cpr from CWD */
...
#define CKPT_TO_SYSLOG                0x10000000      /*  CPR INTERNAL ONLY */
