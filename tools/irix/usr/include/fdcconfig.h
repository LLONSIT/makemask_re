...
#define ENABLE_TEXT_LYR		(_C1 || _CM || _IR || _IA)	/* text */
#define ENABLE_COS_LYR		(_C1 || _CM || _IR || _IA)	/* cos */
#define ENABLE_BMX_LYR		(_C1 || _CH || _CE)	/* tape */
#define ENABLE_IBM_LYR		(_C1 || _IR || _IA)		/* ibm */
#define ENABLE_VMS_LYR		(_C1 || _IR || _IA)		/* vms */
...
#define ENABLE_FD_LYR		(_C1 || _CM || _IR || _IA)	/* fd */
...
#define ENABLE_BUFA_LYR		(_C1 || _CM || _IR || _IA)	/* bufa */
#define ENABLE_CACHEA_LYR	(_C1 || _CM || _IR || _IA)	/* cachea */
#define ENABLE_EVENT_LYR	(_C1 || _CE || _IR || _IA)	/* event */
#define ENABLE_LOCK_LYR		(_C1 || _IR || _IA)		/* lock */
#define ENABLE_GLOBAL_LYR	(       _CM || _IR || _IA)	/* global */
