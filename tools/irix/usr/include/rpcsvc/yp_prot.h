#ifndef __RPCSVC_YP_PROT_H__
#define __RPCSVC_YP_PROT_H__
#ident "$Revision: 1.15 $"
/*
*
 ...
 * between the network information service (NIS) clients and the NIS servers.
 * The servers are the NIS database servers, and the NIS binders.  
 */
...
/*
 * Domain binding data structure, used by ypclnt package.
