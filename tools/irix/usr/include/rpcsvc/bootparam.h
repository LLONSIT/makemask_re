...
#ifdef _KERNEL
struct __kxdr_s;
extern bool_t xdr_bp_machine_name_t(struct __kxdr_s *, bp_machine_name_t *);
extern bool_t xdr_bp_path_t(struct __kxdr_s *, bp_path_t *);
extern bool_t xdr_bp_fileid_t(struct __kxdr_s *, bp_fileid_t *);
extern bool_t xdr_ip_addr_t(struct __kxdr_s *, ip_addr_t *);
extern bool_t xdr_bp_address(struct __kxdr_s *, bp_address *);
extern bool_t xdr_bp_whoami_arg(struct __kxdr_s *, bp_whoami_arg *);
extern bool_t xdr_bp_whoami_res(struct __kxdr_s *, bp_whoami_res *);
extern bool_t xdr_bp_getfile_arg(struct __kxdr_s *, bp_getfile_arg *);
extern bool_t xdr_bp_getfile_res(struct __kxdr_s *, bp_getfile_res *);
#else
