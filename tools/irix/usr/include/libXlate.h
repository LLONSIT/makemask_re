...
struct elf_sgi;
typedef struct elf_sgi* xlate_elf_handle;
#else
#include <libelf.h> /* sets _LIBELF_XTND_EXPANDED_DATA if appropriate */
typedef struct Elf* xlate_elf_handle;
...
int xlate_init_elf(xlate_elf_handle /*elf*/,
    int			  /*open_debug_table*/,
...
int xlate_named_init_elf(xlate_elf_handle /*elf*/,
    const char *	       /*section_name*/,
    xlate_table_con *	       /*table*/);
