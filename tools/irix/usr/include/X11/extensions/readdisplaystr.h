...
#define READDISPLAY_MINOR_VERSION	1
...
typedef struct _ShmReadDisplayRects {
	CARD8	reqType;	/* always ShmReadDisplayRectsReqCode */
	CARD8	readDisplayReqType;	/* always X_ShmReadDisplayRects */
	CARD16	length B16;
	CARD32	window B32;	/* any window on the screen */
	INT16	dstx B16;
	INT16	dsty B16;
	CARD32  hints B32;
	CARD16  width B16;
	...
	CARD32  shmseg B32;
	CARD32  offset B32;
} xShmReadDisplayRectsReq;		
#define sz_xShmReadDisplayRectsReq	28
...
typedef struct {
	...
	CARD32	pad5 B32;
	CARD32	pad6 B32;
} xShmReadDisplayRectsReply;
#define sz_xShmReadDisplayRectsReply	32
