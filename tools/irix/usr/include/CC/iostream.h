...
public: /* Some enums are declared in ios to avoid pollution of
	...
	enum		{ skipws=01,	
			  ...
			  ,boolalpha=0100000	/* bool input/output */
#endif /* bool support */
			  } ;
	static const long 
...
class streambuf {
	...
	ptrdiff_t	blen() const	{ return x_blen; }
...
#if __EDG_ABI_COMPATIBILITY_VERSION>227 /* wchar_t support */
	istream&	operator>>(wchar_t&);
	istream&	operator>>(wchar_t*);
#endif /* wchar_t support */
#endif
...
extern ostream_withassign _Clog ;
...
#ifdef _ABIO32
static class Iostream_init iostream_init;
#endif /* _ABIO32 */
#endif
