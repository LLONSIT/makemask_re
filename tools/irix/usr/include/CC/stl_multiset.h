...
public:
  ...
  const iterator begin() const { return _M_t.begin(); }
  iterator end() { return _M_t.end(); }
  const iterator end() const { return _M_t.end(); }
  reverse_iterator rbegin()  { return _M_t.rbegin(); } 
  const reverse_iterator rbegin() const { return _M_t.rbegin(); } 
  reverse_iterator rend() { return _M_t.rend(); }
  const reverse_iterator rend() const { return _M_t.rend(); }
