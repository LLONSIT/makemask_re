...
__match(_InIt __first, _InIt __last, _RAIt __name, _RAIt __name_end) {
  typedef typename iterator_traits<_RAIt>:: difference_type
          difference_type;
...
__get_formatted_time(_InIt1 __first,  _InIt1 __last,
  ...
  while(__first != __last && __format != __format_end) {
    if (*__format == '%') {
      ...
      switch (__c) {
        case 'a': {
          pair<_InIt1, const string*> __pr =
            __match(__first, __last,
                      __table._M_dayname, __table._M_dayname + 7);
            __first = __pr.first;
        ...
        case 'b': {
          pair<_InIt1, const string*> __pr =
            __match(__first, __last,
                      __table._M_monthname, __table._M_monthname + 12);
            __first = __pr.first;
        ...
        case 'd': {
          pair<_InIt1, bool> __pr =
            __get_integer_nogroup(__first, __last, 10, __t->tm_mday);
            __first = __pr.first;
          if (!__pr.second || __t->tm_mday < 1 || __t->tm_mday > 31) {
        ...
        case 'H': case 'I': {
          pair<_InIt1, bool> __pr =
            __get_integer_nogroup(__first, __last, 10, __t->tm_hour);
            __first = __pr.first;
            if (!__pr.second)
              return make_pair(__first, __format);
            break;
        ...
        case 'j': {
          pair<_InIt1, bool> __pr =
            __get_integer_nogroup(__first, __last, 10, __t->tm_yday);
          __first = __pr.first;
          if (!__pr.second)
            return make_pair(__first, __format);
          break;
        ...
        case 'm': {
          pair<_InIt1, bool> __pr =
            __get_integer_nogroup(__first, __last, 10, __t->tm_mon);
	    --__t->tm_mon;
          __first = __pr.first;
          if (!__pr.second || __t->tm_mon < 0 || __t->tm_mon > 11) {
	    __err |= ios_base::failbit;
            return make_pair(__first, __format);
	  }
          break;
        ...
        case 'M': {
          pair<_InIt1, bool> __pr =
            __get_integer_nogroup(__first, __last, 10, __t->tm_min);
          __first = __pr.first;
          if (!__pr.second)
            return make_pair(__first, __format);
          break;
        ...
        case 'p': {
          pair<_InIt1, const string*> __pr =
            __match(__first, __last, __table._M_am_pm, __table._M_am_pm + 2);
          __first = __pr.first;
        ...
        case 'S': {
          pair<_InIt1, bool> __pr =
            __get_integer_nogroup(__first, __last, 10, __t->tm_sec);
          __first = __pr.first;
          if (!__pr.second)
            return make_pair(__first, __format);
          break;
	...
	case 'y': {
	  pair<_InIt1, bool> __pr =
	    __get_integer_nogroup(__first, __last, 10, __t->tm_year);
 	  __first = __pr.first;
	  if (!__pr.second)
	    return make_pair(__first, __format);
	  break;
...
__get_short_or_long_dayname(_InIt __first, _InIt __last,
  ...
  pair<_InIt, const string*> __pr =
    __match(__first, __last, __table._M_dayname, __table._M_dayname + 14);
  __first = __pr.first;
  __t->tm_wday = (__pr.second - __table._M_dayname) % 7;
...
__get_short_or_long_monthname(_InIt __first, _InIt __last,
                              const _Time_Info& __table, tm* __t) {
  pair<_InIt, const string*> __pr =
    __match(__first, __last, __table._M_monthname, __table._M_monthname + 24);
  __first = __pr.first;
  __t->tm_mon = (__pr.second - __table._M_monthname) % 12;
...
protected:
  ...
  virtual iter_type do_get_year(iter_type __s, iter_type  __end,
    ...
    pair<iter_type, bool> __pr = 
      __get_integer_nogroup(__s, __end, 10, __t->tm_year);
    __t->tm_year -= 1900;
    __err = __pr.second ? ios_base::goodbit : ios_base::failbit;
    if (__pr.first == __end)
      __err |= ios_base::eofbit;
    return __pr.first;
  }
