...
/* The structure for G1 commands is the same as that for G2 commands. */
struct cmd_g1 {
...
#define	 G2_MSEL    0x55	/* Mode Select (10 byte) */
#define	 G2_MSEN    0x5A	/* Mode Sense (10 byte) */


struct cmd_g5
{
	unsigned char g5_b0, g5_b1, g5_b2, g5_b3,
		g5_b4, g5_b5, g5_b6, g5_b7,
		g5_b8, g5_b9, g5_b10, g5_b11;
};

#define g5_op_code	g5_b0	/* operation code */
#define g5_lun_dfr	g5_b1	/* logical unit / D / F / R */
#define g5_lba3		g5_b2	/* logical block address (part 3) */
#define g5_lba2		g5_b3	/* logical block address (part 2) */
#define g5_lba1		g5_b4	/* logical block address (part 1) */
#define g5_lba0		g5_b5	/* logical block address (part 0) */
#define g5_len3		g5_b6	/* transfer length (part 3) */
#define g5_len2		g5_b7	/* transfer length (part 2) */
#define g5_len1		g5_b8	/* transfer length (part 1) */
#define g5_len0		g5_b9	/* transfer length (part 0) */
#define g5_res10	g5_b10	/* reserved */
#define g5_flag_link	g5_b11	/* flag & link bits */
...
int modeselect15(struct dsreq *dsp, caddr_t data, uint datalen,
	          int save, int vu);
int modeselect55(struct dsreq *dsp, caddr_t data, uint datalen,
	          int save, int vu);
...
int modesense5a(struct dsreq *dsp, caddr_t data, uint datalen,
	         int pagectrl, int pagecode, int vu);
int modesenseNB_5a(struct dsreq *dsp, caddr_t data, uint datalen,
			 int pagectrl, int pagecode, int vu);
...
int writeextended2a(struct dsreq *dsp, caddr_t data, uint datalen,
	            uint lba, int vu);
int readcapacity9e(struct dsreq *dsp, caddr_t data, uint datalen,
	            uint64_t lba, int pmi, int vu);

int doscsireq(int fd, struct dsreq *dsp);
void fillg0cmd(struct dsreq *dsp, uchar_t *cmd,
	uchar_t b0, uchar_t b1, uchar_t b2,
	uchar_t b3, uchar_t b4, uchar_t b5);
void fillg1cmd(struct dsreq *dsp, uchar_t *cmd,
	uchar_t b0, uchar_t b1, uchar_t b2, uchar_t b3, uchar_t b4,
	uchar_t b5, uchar_t b6, uchar_t b7, uchar_t b8, uchar_t b9);
void fillg2cmd(struct dsreq *dsp, uchar_t *cmd,
	uchar_t b0, uchar_t b1, uchar_t b2, uchar_t b3, uchar_t b4,
	uchar_t b5, uchar_t b6, uchar_t b7, uchar_t b8, uchar_t b9);
void fillg4cmd (struct dsreq *dsp, uchar_t *cmd,
	uchar_t b0, uchar_t b1, uchar_t b2, uchar_t b3,
	uchar_t b4, uchar_t b5, uchar_t b6, uchar_t b7,
	uchar_t b8, uchar_t b9, uchar_t b10, uchar_t b11,
	uchar_t b12, uchar_t b13, uchar_t b14, uchar_t b15);
void fillg5cmd (struct dsreq *dsp, uchar_t *cmd,
	uchar_t b0, uchar_t b1, uchar_t b2, uchar_t b3,
	uchar_t b4, uchar_t b5, uchar_t b6, uchar_t b7,
	uchar_t b8, uchar_t b9, uchar_t b10, uchar_t b11);

#ifndef fillg2cmd
/* Cannot use #pragma optional if fillg2cmd() has been cpp aliased */
#pragma optional fillg2cmd
#endif
#ifndef fillg5cmd
/* Cannot use #pragma optional if fillg5cmd() has been cpp aliased */
#pragma optional fillg5cmd
#endif
