...
/* This number should be greater than emgrcmd ret codes. check emgrtaskapi.h
 * This one to check errror, before passing the command to emgrd*/ 
#define EVMONAPI_ERR		72
