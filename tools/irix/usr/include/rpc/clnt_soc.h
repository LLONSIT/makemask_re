 ...
 *	void *in, *out;
 */
extern enum clnt_stat callrpc(const char *, rpcprog_t, rpcvers_t, rpcproc_t, 
...
extern CLIENT *clnttcp_create(
	struct sockaddr_in *, rpcprog_t, rpcvers_t, int *, u_int, u_int);
...
extern CLIENT *clntudp_create(
	struct sockaddr_in *, rpcprog_t, rpcvers_t, struct timeval, int *);
