...
#define IXDR_PUT_U_INT32(buf, v)	IXDR_PUT_LONG((buf), ((xdr_long_t)(v)))
...
#ifndef offsetof_xdr
#define offsetof_xdr(t,m) ((off_t)(&(((t *)0)->m)))
#endif
bool_t __xdr_chain(XDR *, void **, u_int, xdrproc_t, off_t);
#else /* _SGI_COMPILING_LIBC */
#pragma optional xdr_sizeof
