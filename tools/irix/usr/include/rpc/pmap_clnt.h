...
extern bool_t		pmap_set(rpcprog_t, rpcvers_t, u_int, u_short);
extern bool_t		pmap_unset(rpcprog_t, rpcvers_t);
extern bool_t		pmap_unset2(rpcprog_t, rpcvers_t, u_int);
extern struct pmaplist	*pmap_getmaps(struct sockaddr_in *);
extern u_short		pmap_getport(struct sockaddr_in *, rpcprog_t,rpcvers_t,u_int);
extern enum clnt_stat	pmap_rmtcall(struct sockaddr_in *, rpcprog_t,rpcvers_t,rpcproc_t,
			    xdrproc_t, void *, xdrproc_t, void *,
			    struct timeval, u_long *);
extern enum clnt_stat	clnt_broadcast(rpcprog_t, rpcvers_t, rpcproc_t,
			    xdrproc_t, void *, xdrproc_t, void *,
			    bool_t (*)(void *, struct sockaddr_in *));
extern enum clnt_stat	clnt_multicast(rpcprog_t, rpcvers_t, rpcproc_t,
			    xdrproc_t, void *, xdrproc_t, void *,
			    bool_t (*)(void *, struct sockaddr_in *));
extern enum clnt_stat	clnt_broadmulti(rpcprog_t, rpcvers_t, rpcproc_t,
			    xdrproc_t, void *, xdrproc_t, void *,
			    bool_t (*)(void *, struct sockaddr_in *),
			    u_char, u_char);
extern enum clnt_stat	clnt_broadcast_exp(rpcprog_t, rpcvers_t, rpcproc_t,
			    xdrproc_t, void *, xdrproc_t, void *,
			    bool_t (*)(void *, struct sockaddr_in *), int,int);
extern enum clnt_stat	clnt_multicast_exp(rpcprog_t, rpcvers_t, rpcproc_t,
			    xdrproc_t, void *, xdrproc_t, void *,
			    bool_t (*)(void *, struct sockaddr_in *), int,int);
extern enum clnt_stat	clnt_broadmulti_exp(rpcprog_t, rpcvers_t, rpcproc_t,
			    xdrproc_t, void *, xdrproc_t, void *,
			    bool_t (*)(void *, struct sockaddr_in *), int,int,
			    u_char, u_char);
