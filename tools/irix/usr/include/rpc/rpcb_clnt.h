...
extern bool_t		rpcb_set(rpcprog_t, rpcvers_t, struct netconfig *,
				struct netbuf *);
extern bool_t		rpcb_unset(rpcprog_t, rpcvers_t, struct netconfig *);
extern RPCBLIST		*rpcb_getmaps(struct netconfig *, const char *);
extern enum clnt_stat	rpcb_rmtcall(struct netconfig *, const char *,
				rpcprog_t, rpcvers_t, rpcproc_t, 
				xdrproc_t, void*, xdrproc_t, void*,
				struct timeval, struct netbuf *);
extern bool_t		rpcb_getaddr(rpcprog_t, rpcvers_t, struct netconfig *, 
				struct netbuf *, const char *);
extern bool_t		rpcb_gettime(const char *, time_t *);
extern char		*rpcb_taddr2uaddr(struct netconfig *, struct netbuf *);
extern struct netbuf	*rpcb_uaddr2taddr(struct netconfig *, char *);

#endif /* defined(_SVR4_TIRPC) || defined(_BSD_TIRPC) */
...
#pragma optional rpcb_set
#pragma optional rpcb_unset
#pragma optional rpcb_getmaps
#pragma optional rpcb_rmtcall
#pragma optional rpcb_getaddr
#pragma optional rpcb_gettime
#pragma optional rpcb_taddr2uaddr
#pragma optional rpcb_uaddr2taddr
#endif /* _BSD_TIRPC */
