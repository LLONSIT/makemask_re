 ...
 *
 * A slightly faster, more direct interface to the Fortran BLAS routines,
 * which requires column-major ordering of matrices, is available with
 * the SCSL Scientific Library.
 *
 */
